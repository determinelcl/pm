...
public class PracticeSummaryController extends BaseController {
     ...
     * @return 添加的结果
     */
    public ResultModel<TrainSummary> add(@RequestBody AddTrainSummaryDto summary) {
     ...
     */
    @PutMapping("/upd/stu")
    public ResultModel<TrainSummary> updateByStu(@RequestBody UpdStuTrainSummaryDto dto) {
     ...
     */
    @PutMapping("/del/{stuId:\\d+}/{summaryId:\\d+}")
